...
CLINVAR_path = "/mnt/NGS_Diagnostik/Variant_databases/CLINVAR/CLINVAR.sdb"
SQLITE = DBI::dbDriver("SQLite")
CONN = dbConnect(SQLITE, CLINVAR_path, encoding = "ISO-8859-1")
CLINVAR = dplyr::tbl(CONN, "CLINVAR")
CLINVAR = janitor::clean_names(CLINVAR)
