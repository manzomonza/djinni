...
```{r}
DT_default(display_variants(snv))
...
* <div style="display: inline-block; width: 25px; height: 10px; background-color: #19A603; border-radius: 10px;"></div> Phred > 3000 
* <div style="display: inline-block; width: 25px; height: 10px; background-color: #99ff99; border-radius: 10px;"></div> 1000 < Phred < 3000 
* <div style="display: inline-block; width: 25px; height: 10px; background-color: #ff6347; border-radius: 10px;"></div> Phred < 100 
* <div style="display: inline-block; width: 25px; height: 10px; background-color: #FFA500; border-radius: 10px;"></div> 100 < Phred < 1000
...
phred_formatter = formattable::formatter("span",
                            style = x ~ style("background-color" = ifelse(x > 1000, "#19A603",
                             ifelse(x < 100, "#ff6347", "#FFA500")), color = "black"))

coverage_formatter = formattable::formatter("span",
                            style = x ~ style("background-color" = ifelse(x > 3000, "#19A603",
